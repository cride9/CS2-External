...
namespace client {
    ...
    public static class CBasePlayerController { // C_BaseEntity
        ...
        public const int m_nInButtonsWhichAreToggles = 0x5D0; // uint64_t
        public const int m_nTickBase = 0x5D8; // uint32_t
        public const int m_hPawn = 0x5DC; // CHandle<C_BasePlayerPawn>
        public const int m_hPredictedPawn = 0x5E0; // CHandle<C_BasePlayerPawn>
        public const int m_nSplitScreenSlot = 0x5E4; // CSplitScreenSlot
        public const int m_hSplitOwner = 0x5E8; // CHandle<CBasePlayerController>
        public const int m_hSplitScreenPlayers = 0x5F0; // CUtlVector<CHandle<CBasePlayerController>>
        public const int m_bIsHLTV = 0x608; // bool
        public const int m_iConnected = 0x60C; // PlayerConnectedState
        public const int m_iszPlayerName = 0x610; // char[128]
        public const int m_steamID = 0x698; // uint64_t
        public const int m_bIsLocalPlayerController = 0x6A0; // bool
        public const int m_iDesiredFOV = 0x6A4; // uint32_t
    }
    ...
    public static class CCSGO_WingmaintroCharacterPosition { // C_CSGO_TeamIntroCharacterPosition
    }

    public static class CCSGO_WingmaintroCounterTerroristPosition { // CCSGO_WingmaintroCharacterPosition
    }

    public static class CCSGO_WingmaintroTerroristPosition { // CCSGO_WingmaintroCharacterPosition
    }
    ...
    public static class CCSPlayerController { // CBasePlayerController
        public const int m_pInGameMoneyServices = 0x6D0; // CCSPlayerController_InGameMoneyServices*
        public const int m_pInventoryServices = 0x6D8; // CCSPlayerController_InventoryServices*
        public const int m_pActionTrackingServices = 0x6E0; // CCSPlayerController_ActionTrackingServices*
        public const int m_pDamageServices = 0x6E8; // CCSPlayerController_DamageServices*
        public const int m_iPing = 0x6F0; // uint32_t
        public const int m_bHasCommunicationAbuseMute = 0x6F4; // bool
        public const int m_szCrosshairCodes = 0x6F8; // CUtlSymbolLarge
        public const int m_iPendingTeamNum = 0x700; // uint8_t
        public const int m_flForceTeamTime = 0x704; // GameTime_t
        public const int m_iCompTeammateColor = 0x708; // int32_t
        public const int m_bEverPlayedOnTeam = 0x70C; // bool
        public const int m_flPreviousForceJoinTeamTime = 0x710; // GameTime_t
        public const int m_szClan = 0x718; // CUtlSymbolLarge
        public const int m_sSanitizedPlayerName = 0x720; // CUtlString
        public const int m_iCoachingTeam = 0x728; // int32_t
        public const int m_nPlayerDominated = 0x730; // uint64_t
        public const int m_nPlayerDominatingMe = 0x738; // uint64_t
        public const int m_iCompetitiveRanking = 0x740; // int32_t
        public const int m_iCompetitiveWins = 0x744; // int32_t
        public const int m_iCompetitiveRankType = 0x748; // int8_t
        public const int m_iCompetitiveRankingPredicted_Win = 0x74C; // int32_t
        public const int m_iCompetitiveRankingPredicted_Loss = 0x750; // int32_t
        public const int m_iCompetitiveRankingPredicted_Tie = 0x754; // int32_t
        public const int m_nEndMatchNextMapVote = 0x758; // int32_t
        public const int m_unActiveQuestId = 0x75C; // uint16_t
        public const int m_nQuestProgressReason = 0x760; // QuestProgress::Reason
        public const int m_unPlayerTvControlFlags = 0x764; // uint32_t
        public const int m_iDraftIndex = 0x790; // int32_t
        public const int m_msQueuedModeDisconnectionTimestamp = 0x794; // uint32_t
        public const int m_uiAbandonRecordedReason = 0x798; // uint32_t
        public const int m_bEverFullyConnected = 0x79C; // bool
        public const int m_bAbandonAllowsSurrender = 0x79D; // bool
        public const int m_bAbandonOffersInstantSurrender = 0x79E; // bool
        public const int m_bDisconnection1MinWarningPrinted = 0x79F; // bool
        public const int m_bScoreReported = 0x7A0; // bool
        public const int m_nDisconnectionTick = 0x7A4; // int32_t
        public const int m_bControllingBot = 0x7B0; // bool
        public const int m_bHasControlledBotThisRound = 0x7B1; // bool
        public const int m_bHasBeenControlledByPlayerThisRound = 0x7B2; // bool
        public const int m_nBotsControlledThisRound = 0x7B4; // int32_t
        public const int m_bCanControlObservedBot = 0x7B8; // bool
        public const int m_hPlayerPawn = 0x7BC; // CHandle<C_CSPlayerPawn>
        public const int m_hObserverPawn = 0x7C0; // CHandle<C_CSObserverPawn>
        public const int m_bPawnIsAlive = 0x7C4; // bool
        public const int m_iPawnHealth = 0x7C8; // uint32_t
        public const int m_iPawnArmor = 0x7CC; // int32_t
        public const int m_bPawnHasDefuser = 0x7D0; // bool
        public const int m_bPawnHasHelmet = 0x7D1; // bool
        public const int m_nPawnCharacterDefIndex = 0x7D2; // uint16_t
        public const int m_iPawnLifetimeStart = 0x7D4; // int32_t
        public const int m_iPawnLifetimeEnd = 0x7D8; // int32_t
        public const int m_iPawnBotDifficulty = 0x7DC; // int32_t
        public const int m_hOriginalControllerOfCurrentPawn = 0x7E0; // CHandle<CCSPlayerController>
        public const int m_iScore = 0x7E4; // int32_t
        public const int m_vecKills = 0x7E8; // C_NetworkUtlVectorBase<EKillTypes_t>
        public const int m_iMVPs = 0x800; // int32_t
        public const int m_bIsPlayerNameDirty = 0x804; // bool
    }
    ...
    public static class CCSPlayer_WeaponServices { // CPlayer_WeaponServices
        public const int m_flNextAttack = 0xA8; // GameTime_t
        public const int m_bIsLookingAtWeapon = 0xAC; // bool
        public const int m_bIsHoldingLookAtWeapon = 0xAD; // bool
    }
    ...
    public static class CCSWeaponBaseVData { // CBasePlayerWeaponVData
        ...
        public const int m_szHeatEffect = 0x6A8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        public const int m_szEjectBrassEffect = 0x788; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        public const int m_szMuzzleFlashParticleAlt = 0x868; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        public const int m_szMuzzleFlashThirdPersonParticle = 0x948; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        public const int m_szMuzzleFlashThirdPersonParticleAlt = 0xA28; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
        public const int m_szTracerParticle = 0xB08; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
    ...
    public static class CDecalInfo {
        ...
        public const int m_pNext = 0x28; // CDecalInfo*
        public const int m_pPrev = 0x30; // CDecalInfo*
        public const int m_nDecalMaterialIndex = 0x90; // int32_t
    }
    ...
    public static class C_BaseCSGrenade { // C_CSWeaponBase
        public const int m_bClientPredictDelete = 0x1990; // bool
        public const int m_bRedraw = 0x1991; // bool
        public const int m_bIsHeldByPlayer = 0x1992; // bool
        public const int m_bPinPulled = 0x1993; // bool
        public const int m_bJumpThrow = 0x1994; // bool
        public const int m_eThrowStatus = 0x1998; // EGrenadeThrowState
        public const int m_fThrowTime = 0x199C; // GameTime_t
        public const int m_flThrowStrength = 0x19A0; // float
        public const int m_flThrowStrengthApproach = 0x19A4; // float
        public const int m_fDropTime = 0x19A8; // GameTime_t
    }

    public static class C_BaseCSGrenadeProjectile { // C_BaseGrenade
        public const int m_vInitialVelocity = 0x1068; // Vector
        public const int m_nBounces = 0x1074; // int32_t
        public const int m_nExplodeEffectIndex = 0x1078; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
        public const int m_nExplodeEffectTickBegin = 0x1080; // int32_t
        public const int m_vecExplodeEffectOrigin = 0x1084; // Vector
        public const int m_flSpawnTime = 0x1090; // GameTime_t
        public const int vecLastTrailLinePos = 0x1094; // Vector
        public const int flNextTrailLineTime = 0x10A0; // GameTime_t
        public const int m_bExplodeEffectBegan = 0x10A4; // bool
        public const int m_bCanCreateGrenadeTrail = 0x10A5; // bool
        public const int m_nSnapshotTrajectoryEffectIndex = 0x10A8; // ParticleIndex_t
        public const int m_hSnapshotTrajectoryParticleSnapshot = 0x10B0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
        public const int m_arrTrajectoryTrailPoints = 0x10B8; // CUtlVector<Vector>
        public const int m_arrTrajectoryTrailPointCreationTimes = 0x10D0; // CUtlVector<float>
        public const int m_flTrajectoryTrailEffectCreationTime = 0x10E8; // float
    }
    ...
    public static class C_BaseModelEntity { // C_BaseEntity
        ...
        public const int m_ConfigEntitiesToPropagateMaterialDecalsTo = 0xC30; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
    ...
    public static class C_C4 { // C_CSWeaponBase
        public const int m_szScreenText = 0x1990; // char[32]
        public const int m_bombdroppedlightParticleIndex = 0x19B0; // ParticleIndex_t
        public const int m_bStartedArming = 0x19B4; // bool
        public const int m_fArmedTime = 0x19B8; // GameTime_t
        public const int m_bBombPlacedAnimation = 0x19BC; // bool
        public const int m_bIsPlantingViaUse = 0x19BD; // bool
        public const int m_entitySpottedState = 0x19C0; // EntitySpottedState_t
        public const int m_nSpotRules = 0x19D8; // int32_t
        public const int m_bPlayedArmingBeeps = 0x19DC; // bool[7]
        public const int m_bBombPlanted = 0x19E3; // bool
        public const int m_bDroppedFromDeath = 0x19E4; // bool
    }
    ...
    public static class C_CSGO_CounterTerroristWingmaintroCamera { // C_CSGO_TeamPreviewCamera
    }
    ...
    public static class C_CSGO_PreviewPlayer { // C_CSPlayerPawn
        public const int m_animgraph = 0x22E0; // CUtlString
        public const int m_animgraphCharacterModeString = 0x22E8; // CUtlString
        public const int m_flInitialModelScale = 0x22F0; // float
    }
    ...
    public static class C_CSGO_TerroristWingmaintroCamera { // C_CSGO_TeamPreviewCamera
    }
    ...
    public static class C_CSGameRules { // C_TeamplayRules
        ...
        public const int m_bMatchAbortedDueToPlayerBan = 0xD68; // bool
        public const int m_bHasTriggeredRoundStartMusic = 0xD69; // bool
        public const int m_bHasTriggeredCoopSpawnReset = 0xD6A; // bool
        public const int m_bSwitchingTeamsAtRoundReset = 0xD6B; // bool
    ...
    public static class C_CSPlayerPawn { // C_CSPlayerPawnBase
        ...
        public const int m_bLastHeadBoneTransformIsValid = 0x22A8; // bool
        public const int m_lastLandTime = 0x22AC; // GameTime_t
        public const int m_bOnGroundLastTick = 0x22B0; // bool
        public const int m_qDeathEyeAngles = 0x22CC; // QAngle
        public const int m_bSkipOneHeadConstraintUpdate = 0x22D8; // bool
    }
    ...
    public static class C_CSWeaponBase { // C_BasePlayerWeapon
        public const int m_flFireSequenceStartTime = 0x15D0; // float
        public const int m_nFireSequenceStartTimeChange = 0x15D4; // int32_t
        public const int m_nFireSequenceStartTimeAck = 0x15D8; // int32_t
        public const int m_bPlayerFireEventIsPrimary = 0x15DC; // bool
        public const int m_seqIdle = 0x15E0; // HSequence
        public const int m_seqFirePrimary = 0x15E4; // HSequence
        public const int m_seqFireSecondary = 0x15E8; // HSequence
        ...
        public const int m_IronSightController = 0x1890; // C_IronSightController
        public const int m_iIronSightMode = 0x1940; // int32_t
        public const int m_flLastLOSTraceFailureTime = 0x1950; // GameTime_t
        public const int m_iNumEmptyAttacks = 0x1954; // int32_t
    }

    public static class C_CSWeaponBaseGun { // C_CSWeaponBase
        public const int m_zoomLevel = 0x1990; // int32_t
        public const int m_iBurstShotsRemaining = 0x1994; // int32_t
        public const int m_iSilencerBodygroup = 0x1998; // int32_t
        public const int m_silencedModelIndex = 0x19A8; // int32_t
        public const int m_inPrecache = 0x19AC; // bool
        public const int m_bNeedsBoltAction = 0x19AD; // bool
    }
    ...
    public static class C_CommandContext {
        ...
        public const int command_number = 0x78; // int32_t
    }
    ...
    public static class C_DecoyProjectile { // C_BaseCSGrenadeProjectile
        public const int m_nDecoyShotTick = 0x10F0; // int32_t
        public const int m_nClientLastKnownDecoyShotTick = 0x10F4; // int32_t
        public const int m_flTimeParticleEffectSpawn = 0x1118; // GameTime_t
    }
    ...
    public static class C_Fists { // C_CSWeaponBase
        public const int m_bPlayingUinterruptableAct = 0x1990; // bool
        public const int m_nUinterruptableActivity = 0x1994; // PlayerAnimEvent_t
    }
    ...
    public static class C_Melee { // C_CSWeaponBase
        public const int m_flThrowAt = 0x1990; // GameTime_t
    }
    ...
    public static class C_MolotovProjectile { // C_BaseCSGrenadeProjectile
        public const int m_bIsIncGrenade = 0x10F0; // bool
    }
    ...
    public static class C_SmokeGrenadeProjectile { // C_BaseCSGrenadeProjectile
        public const int m_nSmokeEffectTickBegin = 0x10F8; // int32_t
        public const int m_bDidSmokeEffect = 0x10FC; // bool
        public const int m_nRandomSeed = 0x1100; // int32_t
        public const int m_vSmokeColor = 0x1104; // Vector
        public const int m_vSmokeDetonationPos = 0x1110; // Vector
        public const int m_VoxelFrameData = 0x1120; // CUtlVector<uint8_t>
        public const int m_bSmokeVolumeDataReceived = 0x1138; // bool
        public const int m_bSmokeEffectSpawned = 0x1139; // bool
    }
    ...
    public static class C_WeaponBaseItem { // C_CSWeaponBase
        public const int m_SequenceCompleteTimer = 0x1990; // CountdownTimer
        public const int m_bRedraw = 0x19A8; // bool
    }
    ...
    public static class C_WeaponShield { // C_CSWeaponBaseGun
        public const int m_flDisplayHealth = 0x19B0; // float
    }

    public static class C_WeaponTaser { // C_CSWeaponBaseGun
        public const int m_fFireTime = 0x19B0; // GameTime_t
    }
