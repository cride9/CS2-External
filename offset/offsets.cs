...
namespace CSharp {
    ...
    public static class client_dll { // client.dll
        public const long dwBaseEntityModel_setModel = 0x583320;
        public const long dwEntityList = 0x17ADAE0;
        public const long dwForceBackward = 0x16B25E0;
        public const long dwForceCrouch = 0x16B28B0;
        public const long dwForceForward = 0x16B2550;
        public const long dwForceJump = 0x16B2820;
        public const long dwForceLeft = 0x16B2670;
        public const long dwForceRight = 0x16B2700;
        public const long dwGameEntitySystem = 0x18D72D0;
        public const long dwGameEntitySystem_getBaseEntity = 0x606930;
        public const long dwGameEntitySystem_getHighestEntityIndex = 0x5F8620;
        public const long dwGameRules = 0x1809720;
        public const long dwGlobalVars = 0x16AE498;
        public const long dwGlowManager = 0x1809748;
        public const long dwInterfaceLinkList = 0x1904F68;
        public const long dwLocalPlayerController = 0x17FCDB8;
        public const long dwLocalPlayerPawn = 0x16B9380;
        public const long dwPlantedC4 = 0x1810CC8;
        public const long dwPrediction = 0x16B9250;
        public const long dwViewAngles = 0x186B0F8;
        public const long dwViewMatrix = 0x180C0E0;
        public const long dwViewRender = 0x180C938;
    }
    ...
    public static class CBasePlayerController { // C_BaseEntity
        ...
        public const long m_nInButtonsWhichAreToggles = 0x5D0; // uint64_t
        public const long m_nTickBase = 0x5D8; // uint32_t
        public const long m_hPawn = 0x5DC; // CHandle<C_BasePlayerPawn>
        public const long m_hPredictedPawn = 0x5E0; // CHandle<C_BasePlayerPawn>
        public const long m_nSplitScreenSlot = 0x5E4; // CSplitScreenSlot
        public const long m_hSplitOwner = 0x5E8; // CHandle<CBasePlayerController>
        public const long m_hSplitScreenPlayers = 0x5F0; // CUtlVector<CHandle<CBasePlayerController>>
        public const long m_bIsHLTV = 0x608; // bool
        public const long m_iConnected = 0x60C; // PlayerConnectedState
        public const long m_iszPlayerName = 0x610; // char[128]
        public const long m_steamID = 0x698; // uint64_t
        public const long m_bIsLocalPlayerController = 0x6A0; // bool
        public const long m_iDesiredFOV = 0x6A4; // uint32_t
    }

    public static class CCSPlayerController { // CBasePlayerController
        public const long m_pInGameMoneyServices = 0x6D0; // CCSPlayerController_InGameMoneyServices*
        public const long m_pInventoryServices = 0x6D8; // CCSPlayerController_InventoryServices*
        public const long m_pActionTrackingServices = 0x6E0; // CCSPlayerController_ActionTrackingServices*
        public const long m_pDamageServices = 0x6E8; // CCSPlayerController_DamageServices*
        public const long m_iPing = 0x6F0; // uint32_t
        public const long m_bHasCommunicationAbuseMute = 0x6F4; // bool
        public const long m_szCrosshairCodes = 0x6F8; // CUtlSymbolLarge
        public const long m_iPendingTeamNum = 0x700; // uint8_t
        public const long m_flForceTeamTime = 0x704; // GameTime_t
        public const long m_iCompTeammateColor = 0x708; // int32_t
        public const long m_bEverPlayedOnTeam = 0x70C; // bool
        public const long m_flPreviousForceJoinTeamTime = 0x710; // GameTime_t
        public const long m_szClan = 0x718; // CUtlSymbolLarge
        public const long m_sSanitizedPlayerName = 0x720; // CUtlString
        public const long m_iCoachingTeam = 0x728; // int32_t
        public const long m_nPlayerDominated = 0x730; // uint64_t
        public const long m_nPlayerDominatingMe = 0x738; // uint64_t
        public const long m_iCompetitiveRanking = 0x740; // int32_t
        public const long m_iCompetitiveWins = 0x744; // int32_t
        public const long m_iCompetitiveRankType = 0x748; // int8_t
        public const long m_iCompetitiveRankingPredicted_Win = 0x74C; // int32_t
        public const long m_iCompetitiveRankingPredicted_Loss = 0x750; // int32_t
        public const long m_iCompetitiveRankingPredicted_Tie = 0x754; // int32_t
        public const long m_nEndMatchNextMapVote = 0x758; // int32_t
        public const long m_unActiveQuestId = 0x75C; // uint16_t
        public const long m_nQuestProgressReason = 0x760; // QuestProgress::Reason
        public const long m_unPlayerTvControlFlags = 0x764; // uint32_t
        public const long m_iDraftIndex = 0x790; // int32_t
        public const long m_msQueuedModeDisconnectionTimestamp = 0x794; // uint32_t
        public const long m_uiAbandonRecordedReason = 0x798; // uint32_t
        public const long m_bCannotBeKicked = 0x79C; // bool
        public const long m_bEverFullyConnected = 0x79D; // bool
        public const long m_bAbandonAllowsSurrender = 0x79E; // bool
        public const long m_bAbandonOffersInstantSurrender = 0x79F; // bool
        public const long m_bDisconnection1MinWarningPrinted = 0x7A0; // bool
        public const long m_bScoreReported = 0x7A1; // bool
        public const long m_nDisconnectionTick = 0x7A4; // int32_t
        public const long m_bControllingBot = 0x7B0; // bool
        public const long m_bHasControlledBotThisRound = 0x7B1; // bool
        public const long m_bHasBeenControlledByPlayerThisRound = 0x7B2; // bool
        public const long m_nBotsControlledThisRound = 0x7B4; // int32_t
        public const long m_bCanControlObservedBot = 0x7B8; // bool
        public const long m_hPlayerPawn = 0x7BC; // CHandle<C_CSPlayerPawn>
        public const long m_hObserverPawn = 0x7C0; // CHandle<C_CSObserverPawn>
        public const long m_bPawnIsAlive = 0x7C4; // bool
        public const long m_iPawnHealth = 0x7C8; // uint32_t
        public const long m_iPawnArmor = 0x7CC; // int32_t
        public const long m_bPawnHasDefuser = 0x7D0; // bool
        public const long m_bPawnHasHelmet = 0x7D1; // bool
        public const long m_nPawnCharacterDefIndex = 0x7D2; // uint16_t
        public const long m_iPawnLifetimeStart = 0x7D4; // int32_t
        public const long m_iPawnLifetimeEnd = 0x7D8; // int32_t
        public const long m_iPawnBotDifficulty = 0x7DC; // int32_t
        public const long m_hOriginalControllerOfCurrentPawn = 0x7E0; // CHandle<CCSPlayerController>
        public const long m_iScore = 0x7E4; // int32_t
        public const long m_vecKills = 0x7E8; // C_NetworkUtlVectorBase<EKillTypes_t>
        public const long m_iMVPs = 0x800; // int32_t
        public const long m_bIsPlayerNameDirty = 0x804; // bool
    }
